...
public:
	...
	void training(param myParam, double & copyProb);
	void initialization(param myParam, vector_2str stringX, vector_2str stringY);
	long double maximization(param myParam, bool collectCopyCounts, double &copyProb);
	...
	void createAlignments(param myParam, double copyProb);
	long double viterbi_align(param myParam, vector_str x, vector_str y, vector<string> *alignX, vector<string> *alignY);
	vector<long double> nViterbi_align(param myParam, vector_str x, vector_str y, vector_2str &alignX, vector_2str &alignY, double copyProb);
